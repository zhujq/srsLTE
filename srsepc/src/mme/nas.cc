                                              ...
                                              srslte::log*            nas_log)
{
  ...
  nas_log->console("Sent tracking area reject with cause: %d.\n", cause);
  nas_log->info("Sent tracking area reject with cause: %d.\n", cause);
  return true;
}
...
bool nas::handle_tracking_area_update_request(srslte::byte_buffer_t* nas_rx)
{
  ...
  m_nas_log->console("Sent tracking area reject with cause: %d.\n", cause);
  m_nas_log->info("Sent tracking area reject with cause: %d.\n", cause);
  return true;
}
